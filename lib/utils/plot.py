...
def show_seg_result(img, result, index, epoch, save_dir=None, is_ll=False,palette=None,is_demo=False,is_gt=False):
    ...
    img = cv2.resize(img, (1280, 720), interpolation=cv2.INTER_LINEAR) # BDD
    # img = cv2.resize(img, (1280, 960), interpolation=cv2.INTER_LINEAR) # self
    # img = cv2.resize(img, (1224, 370), interpolation=cv2.INTER_LINEAR)  # kitti
